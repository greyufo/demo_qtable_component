      ...
      <div class="row">
        <q-card square class="shadow-24" style="width:300px;height:485px;">
          <q-card-section class="bg-deep-purple-7">
            <h4 class="text-h5 text-white q-my-md">MyCloudbox вход</h4>
          ...
          <q-card-section>
            <q-form class="q-px-sm q-pt-xl">
              ...
              <q-input square clearable v-model="password" type="password" label="">
                <template v-slot:prepend>
                  <q-icon name="lock" />
                </template>
              </q-input>
          ...
          <q-card-actions class="q-px-lg">
            <q-btn unelevated size="lg" color="purple-4" class="full-width text-white" label="Вход" />
          </q-card-actions>
